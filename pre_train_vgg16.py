...
# Images are resized to match VGG16 input requirements (224x224)
...
# Freeze VGG16 layers to prevent weight updates during training
# This helps in transfer learning and reduces training time
